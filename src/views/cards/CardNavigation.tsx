  ...
  return (
    ...
    <label htmlFor="default-checkbox" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"> 01.1-02-Five-Whys-Method
            ...
            <TabPanel value='3' sx={{ p: 0 }}>
              ...
              {moduleChallenge && <Typography variant='body2' sx={{ marginBottom: 4 }}>
                {moduleChallenge}
              </Typography>}
              ...
              {moduleChallengeLink && <a target="_blank" rel="noreferrer" href={moduleChallengeLink}><Button variant='contained'> Go to Module Challenge Document</Button></a>
              }          </TabPanel>
            {glossaryTerms && <TabPanel value='4' sx={{ p: 0 }}>
              {/* <Typography variant='h6' sx={{ marginBottom: 2 }}>
              Header Three
            </Typography> */}
              <Typography variant='body2' sx={{ marginBottom: 4 }}>
